...
function createOrderForm() {
  ...
  excel.set(0, 0, undefined, '23');
  excel.set(0, 3, undefined, '20');
  for(var i = 4; i < 7; i++) {
    excel.set(0, i, undefined, 5);
  }
  ...
  var underline_bold_num = excel.addStyle({ border: 'none, none, none, thin #333333', font: 'Arial 10 #333333 B', format: '@', isstring: 'false' });
  ...
  excel.set({ sheet: 0, row: 8, column: 1, value: $('#order-form-amount').val(), style: underline_num });
  excel.set({ sheet: 0, row: 8, column: 2, value: '$' + $('#order-form-price').val(), style: underline_num });
  ...
  excel.set({ sheet: 0, row: 9, column: 3, value: '$' + ($('#order-form-amount').val() * $('#order-form-price').val()), style: underline_bold_num });
  ...
  excel.set({ sheet: 0, row: 16, column: 0, value: '$0.00', style: center });
  excel.set({ sheet: 0, row: 16, column: 3, value: '$0.00', style: overline_bold_center });
